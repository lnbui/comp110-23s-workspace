...
def greet() -> None:
  ...
  print("Naturally, victory is its own reward. After every victory, you will have gained victory points {MONEY} that you can use to upgrade your attack or defense. However--once your life points are all out, then that's the end of the game. You will begin with 10 attack, defense, life, and victory points to start.")
...
def main() -> None:
    ...
    while play_game is True and life_points > 0:
       ...
       print (f"Current Victory Points: {victory_points} {MONEY}")
    ...
    if play_game is False:
       ...
       print (f"Final Victory Points: {victory_points} {MONEY}")
...
def fight() -> None:
  ...
  if enemy_health <= 0:
    ...
    victory_points += (round_number + randint(1,10))
  if fight_choice == 1:
    attack()
  if fight_choice == 2:
    defend()  
...
def upgrade() -> None:
  ...
  global victory_points
  shop_choice: int = 0
  while victory_points > 0:
    print(f"Welcome! You have {victory_points} left to spend! {MONEY}")
    ...
    if shop_choice == 1:
      ...
      if upgrade_attack <= victory_points:
      ...
      if upgrade_defense <= victory_points:
      ...
      if upgrade_life <= victory_points:
